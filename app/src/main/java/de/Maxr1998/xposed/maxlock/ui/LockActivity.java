...
public class LockActivity extends AppCompatActivity implements AuthenticationSucceededListener {
    ...
    private void defaultSetup() {
        ...
        setContentView(new LockView(this, null, names[0], names[1]), new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
    }
